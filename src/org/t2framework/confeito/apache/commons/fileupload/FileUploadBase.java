 ...
 */
package org.t2framework.confeito.apache.commons.fileupload;
...
import org.t2framework.confeito.apache.commons.fileupload.MultipartStream.ItemInputStream;
import org.t2framework.confeito.apache.commons.fileupload.util.Closeable;
import org.t2framework.confeito.apache.commons.fileupload.util.FileItemHeadersImpl;
import org.t2framework.confeito.apache.commons.fileupload.util.LimitedInputStream;
		...
		private boolean findNextItem() throws IOException {
			...
			for (;;) {
				...
				if (currentFieldName == null) {
					...
					if (fileName != null) {
						currentItem = new FileItemStreamImpl(fileName,
								currentFieldName, headers
										.getHeader(CONTENT_TYPE), false,
