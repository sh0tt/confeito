...
import org.t2framework.confeito.apache.commons.fileupload.FileItemFactory;
import org.t2framework.confeito.apache.commons.io.FileCleaningTracker;
 ...
 * 
 * <p>
 * When using the <code>DiskFileItemFactory</code>, then you should consider the
 * following: Temporary files are automatically deleted as soon as they are no
 * longer needed. (More precisely, when the corresponding instance of
 * {@link java.io.File} is garbage collected.) Cleaning up those files is done
 * by an instance of {@link FileCleaningTracker}, and an associated thread. In a
 * complex environment, for example in a web application, you should consider
 * terminating this thread, for example, when your web application ends. See the
 * section on "Resource cleanup" in the users guide of commons-fileupload.
 * </p>
 * 
...
public class DiskFileItemFactory implements FileItemFactory {
	 ...
	 *         {@link org.apache.commons.io.FileCleaner#getInstance()}. Null, if
	 ...
	 *            now on track the created files. May be null to disable
	 *            tracking.
	 */
